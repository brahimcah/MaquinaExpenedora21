...
public class Application{
    ...
    public static String[] llistaNomProducte = {"Chips Casolanes","Xocolata amb Ametlles","Coca-Cola","Aigua 50ml","ColaCao ml","Galetes Veganes","Sanwitch de Pavo","Filipinos","Magdalena","Palmera"};
    
    //Declaració array públic amb el preu dels productes.
    public static double[] llistaPreuProducte = {1.50,1,2,0.75,1.85,1.55,2.50,1,1.10,1.25};

    //Declaració array públic amb la quantitat d'estoc.
    public static int[] llistaStockProducte = {20,12,20,7,18,15,5,1,11,12};
    ...
    public static void main(String[] args){
        ...
        impressio(nomProducte, preuProducte, stockProducte);//Impressió dels productes.
        ...
        do{
            ...
            if(codi==99){ //Per accedir a manteniment.
                ...
                if(Stock.nomProducteStock(codi, llistaNomProducte, llistaStockProducte)!="?"){//Comprovació de Stock, en cas d'haver Stock es seguirà amb el programa
                    ...
                    if(Diners.diners(codi)>=0){
                        System.out.println("Aqui tens el teu producte" + llistaNomProducte[codi]);
